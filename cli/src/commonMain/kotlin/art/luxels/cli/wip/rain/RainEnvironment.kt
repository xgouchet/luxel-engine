...
class RainEnvironment(
    ...
    private val noiseField = VectorNoiseGenerator<D2, D1>(PerlinNoiseGenerator(), D1)
    ...
    internal val lightWaveLength = RndGen.double.inRange(EMSColorSource.MEAN_BLUE, EMSColorSource.MEAN_RED)

    init {
        println("Noise offset = $noiseOffset")
