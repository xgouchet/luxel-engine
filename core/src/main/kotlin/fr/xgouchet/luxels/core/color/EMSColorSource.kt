...
data class EMSColorSource(
    ...
    companion object {
        ...
        const val MIN_FALLOFF: WavelengthNanometer = 420.0

        const val PURE_VIOLET: WavelengthNanometer = 380.0
        const val PURE_BLUE: WavelengthNanometer = 440.0
        const val PURE_TEAL: WavelengthNanometer = 490.0
        const val PURE_GREEN: WavelengthNanometer = 510.0
        const val PURE_YELLOW: WavelengthNanometer = 580.0
        const val PURE_RED: WavelengthNanometer = 645.0

        const val MAX_FALLOFF: WavelengthNanometer = 700.0
