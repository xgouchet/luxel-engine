                    ...
                    if (target.platformType in jvmMainPlatformTypes) {
                        target.compilations.forEach { compilation ->
                            compilation.kotlinSourceSets.forEach {
                                println("${target.name} / ${compilation.name}")
